...
var ElementFormsService = (function () {
    function ElementFormsService(_http) {
        ...
        this.postUrl = 'http://adrienleteinturier.ddns.net/action';
    }
...
var WeatherService = (function () {
    ...
    WeatherService.prototype.getYourPosition = function (lat, long) {
        return this._http.get("http://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + long + "&units=metric&appid=" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].weatherApi.apiKeys)
